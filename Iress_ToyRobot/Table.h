...
private:
    ...
    // consider changing to a vector or other data structure in case additional robots will be supported, consider
    // having an ID for each robot
    Robot m_Robot1;
...
public:
    ...
    // the only reason a Table class is created is for future support for scenarios like: additional robots, additional
    // rules regarding the table e.g. obstacles
